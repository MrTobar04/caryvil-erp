...
| [ADR-0010](file:///d:/UDB/CICLO-10-2026/DES/PROYECTO/caryvil-erp/docs/adr/ADR-0010-historial-compras-y-trazabilidad-transaccional-clientes.md) | Historial de Compras y Trazabilidad Transaccional de Clientes | `Accepted` | 2026-09-16 | `spec-5.2.2`, `spec-5.1.1`, `spec-5.2.1`, `spec-9.1.1` |
